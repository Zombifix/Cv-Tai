...
export default function Tailor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Pre-check de triage: estimation rapide avant generation complete
    try {
  ...
  return (
    <>
      <Layout>
        <div className="max-w-3xl mx-auto flex flex-col gap-8 animate-in slide-in-from-bottom-4 duration-500">
          <div className="text-center space-y-3 mt-4">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-foreground">Tailoring</h1>
            <p className="text-lg text-muted-foreground max-w-xl mx-auto">
              Colle une annonce et genere un CV cible a partir de ton Super CV.
            </p>
          </div>
          ...
          <Card className="shadow-lg border-border/60 bg-card/50 backdrop-blur-sm overflow-hidden relative">
            ...
            <CardContent className="p-6 md:p-10">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                {/* â”€â”€ CHARACTER LIMITS â”€â”€ */}
                <div className="space-y-4 pt-2">
                  <h3 className="text-sm font-semibold flex items-center gap-2 text-muted-foreground">
                    Limites de caracteres <span className="text-xs font-normal">(optionnel â€” adapte a ton template CV)</span>
                  </h3>
      ...
      {/* â”€â”€ Low-match confirmation dialog â”€â”€ */}
